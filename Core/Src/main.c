...
/* Private define ------------------------------------------------------------*/
/* USER CODE BEGIN PD */
#define LED3_TOG HAL_GPIO_TogglePin(LD3_GPIO_Port, LD3_Pin)
/* USER CODE END PD */
...
/* USER CODE BEGIN Header_StartDefaultTask_LED */
/**
...
/* USER CODE BEGIN Header_StartTask_UART_Tx */
/**
...
void StartTask_UART_Tx(void *argument)
{
  ...
  /* USER CODE END StartTask_UART_Tx */
}
